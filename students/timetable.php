    ...
    <div id="main-content">
        <div class="container">
            <div id="content-area" class="clearfix">
                <div id="left-area">
                    <article id="post-12105" class="et_pb_post post-12105 post type-post status-publish format-standard hentry category-teaching-timetable">
                                    ...
                                    <div class="et_pb_section et_pb_section_0 et_pb_fullwidth_section et_section_regular et_pb_section--with-menu">
                                        ...
                                        <div class="et_pb_module et_pb_fullwidth_menu et_pb_fullwidth_menu_0 et_pb_bg_layout_dark  et_pb_text_align_left et_dropdown_animation_fade et_pb_fullwidth_menu--without-logo et_pb_fullwidth_menu--style-left_aligned">
                                            <div class="et_pb_row clearfix">
                                                ...
                                                <div class="et_pb_menu__wrap" style="background-color:lightseagreen !important;">
                                                    <div class="et_pb_menu__menu">
                                                        <nav class="et-menu-nav fullwidth-menu-nav">
                                                            <ul id="menu-timetables" class="et-menu fullwidth-menu nav downwards">
                                                                <li id="menu-item-10841" class="et_pb_menu_page_id-10841 menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-10841"><a href="https://www.must.ac.ke/teaching-timetables/" aria-current="page">Teaching Timetable</a></li>
                                                                <li id="menu-item-10844" class="et_pb_menu_page_id-10844 menu-item menu-item-type-custom menu-item-object-custom menu-item-10844"><a href="https://www.must.ac.ke/exam-timetables/">Exam Timetable</a></li>
                                                            </ul>
                                                        </nav>
                                                    </div>
                                                    ...
                                                    <div class="et_mobile_nav_menu">
                                                        <div class="mobile_nav closed">
                                                            ...
                                                            <ul id="mobile_menu1" class="et_mobile_menu">
                                                                <li id="menu-item-10841" class="et_pb_menu_page_id-10841 menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-10841 et_first_mobile_item"><a href="https://www.must.ac.ke/teaching-timetables/" aria-current="page">Teaching Timetable</a></li>
                                                                <li id="menu-item-10844" class="et_pb_menu_page_id-10844 menu-item menu-item-type-custom menu-item-object-custom menu-item-10844"><a href="https://www.must.ac.ke/exam-timetables/">Exam Timetable</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
