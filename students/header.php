...
<head>
    ...
    <link rel="icon" type="image/png" href="../assets/images/ktti.png">
    <title>HOME | KARUMO TECHNICAL TRAINING INSTITUTE </title>
    <style>
        @font-face {
            font-family: ETmodules;
            font-display: block;
            src: url(//www.must.ac.ke/wp-content/themes/Divi/core/admin/fonts/modules/all/modules.eot);
                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="events-details.html" class="nav-link">Brochures</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="events-details.html" class="nav-link">Application Process</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="events-details.html" class="nav-link">Application Forms</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
